...
*/}}
{{- define "unifi-controller.matchLabels" -}}
app.kubernetes.io/name: {{ include "unifi-controller.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}
...
{{/*
Return the proper unifi-controller exporter image name
*/}}
{{- define "unifi-controller.metrics.image" -}}
...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "unifi-controller.metrics.fullname" -}}
{{- $name := default .Chart.Name .Values.nameOverride -}}
...
Usage:
{{ include "unifi-controller.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "unifi-controller.tplValue" -}}
...
*/}}
{{- define "unifi-controller.imagePullSecrets" -}}
{{- if .Values.global }}
...
{{- end }}
{{- else }}
{{- $imagePullSecrets := coalesce .Values.image.pullSecrets .Values.metrics.image.pullSecrets -}}
{{- if $imagePullSecrets }}
imagePullSecrets:
