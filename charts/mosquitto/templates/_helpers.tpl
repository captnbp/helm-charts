...
Usage:
{{ include "mosquitto.tplValue" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "mosquitto.tplValue" -}}
...
{{/*
Return the proper mosquitto exporter image name
*/}}
{{- define "mosquitto.metrics.image" -}}
